                        ...
                        >
                          <div className="flex items-start justify-between gap-4 mb-4">
                            ...
                            <a 
                              ...
                              className="flex items-center gap-1 text-xs font-medium text-white bg-violet-500 hover:bg-violet-600 px-2.5 py-1 rounded-full transition-colors"
                            >
                        ...
                        >
                          <div className="flex items-start justify-between gap-4 mb-4">
                            ...
                            <a 
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-1 text-xs font-medium text-white bg-amber-500 hover:bg-amber-600 px-2.5 py-1 rounded-full transition-colors"
                            >
                              <FileText className="w-3 h-3" />
                              {treatment.studies} studies
                            </a>
