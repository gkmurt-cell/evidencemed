...
const categories: Category[] = [
  ...
  },
  {
    ...
    conditions: [
      ...
      { id: "glioblastoma", name: "Glioblastoma", description: "Aggressive brain tumor research", studies: "380+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "meningioma", name: "Meningioma", description: "Meningeal tumor studies", studies: "210+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "medulloblastoma", name: "Medulloblastoma", description: "Pediatric brain tumor research", studies: "175+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "acoustic-neuroma", name: "Acoustic Neuroma", description: "Vestibular schwannoma studies", studies: "120+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "pituitary-tumors", name: "Pituitary Tumors", description: "Pituitary adenoma research", studies: "245+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      ...
      { id: "head-neck-cancer", name: "Head & Neck Cancer", description: "Oral, pharyngeal, and laryngeal cancers", studies: "280+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "testicular-cancer", name: "Testicular Cancer", description: "Testicular germ cell tumors", studies: "195+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "mesothelioma", name: "Mesothelioma", description: "Asbestos-related lung lining cancer", studies: "165+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "gallbladder-cancer", name: "Gallbladder Cancer", description: "Biliary tract malignancies", studies: "145+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "endometrial-cancer", name: "Endometrial Cancer", description: "Uterine lining malignancy", studies: "320+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "sarcoma", name: "Sarcoma", description: "Bone and soft tissue cancers", studies: "275+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "adrenal-cancer", name: "Adrenal Cancer", description: "Adrenal gland tumors", studies: "125+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "bile-duct-cancer", name: "Bile Duct Cancer", description: "Cholangiocarcinoma research", studies: "180+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
      { id: "small-intestine-cancer", name: "Small Intestine Cancer", description: "Rare digestive tract malignancy", studies: "95+", icon: Dna, color: "bg-rose-500/10 text-rose-600" },
    ],
  },
  {
    id: "womens-health",
