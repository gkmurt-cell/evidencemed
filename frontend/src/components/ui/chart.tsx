...
// Simplified tooltip content without complex type inference
...
// Simplified legend content without complex type inference
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: any, key: string) {
  ...
  if (payloadPayload) {
    ...
    } else if (payload.dataKey && payload.dataKey in payloadPayload) {
      configLabelKey = payloadPayload[payload.dataKey];
    }
  }
